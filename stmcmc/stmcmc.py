...
class StMcmc:
    def __init__(self, comm=MPI.COMM_WORLD):
        ...
        self.loglike_ = []
        self.modelid_ = 0
        self.maxcount_ = 100 ####Needed for max

    def Run(self, logprior_fun, loglike_fun, data, init_thetas, outfile=None, nsamp=128, modelid=0, max_num_steps=1000, maxcount=100): ####Needed for max
        if outfile is None:
        ...
        self.maxcount_ = maxcount ####Needed for max
        ...
        for istep in range(0, self.max_num_steps_):
            ...
            rest = 1.0
            totalcount = 0 ####Needed for max
            while ((rest > targrho) and (totalcount<self.maxcount_)): ####Needed for max
                totalcount = totalcount + 1 ####Needed for max

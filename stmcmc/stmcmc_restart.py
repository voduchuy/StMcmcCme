...
class StMcmc_restart:
    ...
    def Run(self, logprior_fun, loglike_fun, data, outfile=None, nsamp=128, modelid=0, max_num_steps=1000, maxcount=100):
        if outfile is None:
        ...
        theta = inputdat['theta']
        lastistep = theta.shape[2]-1

 ...
 * ===========================================================================================
 * 
 * This file is header file for EpiRK5C.cpp. 
...
namespace EpiRK5CNamespace
{
    
    // Constants used in EpiRK5C
    ...
    static const realtype g3Times[] = {g33};
...
{
public:
    EpiRK5C(CVRhsFn f, CVSpilsJacTimesVecFn jtv, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    EpiRK5C(CVRhsFn f, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    EpiRK5C(CVRhsFn f, EPICNumJacDelta delta, void *userData, int maxKrylovIters, N_Vector tmpl, const int vecLength);
    ~EpiRK5C();
...
private:
    ...
    EpiRK5C(const EpiRK5C &);  // no implementation
    EpiRK5C & operator=(const EpiRK5C &);  // no implementation
};

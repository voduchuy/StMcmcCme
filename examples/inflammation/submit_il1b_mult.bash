...
#SBATCH --job-name=il1b_mult             # Name of job
...
mpiexec --bind-to core --npernode $cores --n $(($cores*$nodes)) python ~/st-mcmc-cme/examples/inflammation/il1beta_stmcmc_mult.py
mpiexec --bind-to core --npernode $cores --n $(($cores*$nodes)) python ~/st-mcmc-cme/examples/inflammation/il1beta_predict_mult.py

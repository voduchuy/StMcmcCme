...
#SBATCH --job-name=il1b_full             # Name of job
...
mpiexec --bind-to core --npernode $cores --n $(($cores*$nodes)) python ~/st-mcmc-cme/examples/inflammation/il1beta_stmcmc_full.py
mpiexec --bind-to core --npernode $cores --n $(($cores*$nodes)) python ~/st-mcmc-cme/examples/inflammation/il1beta_predict_full.py

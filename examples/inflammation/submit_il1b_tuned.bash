...
#SBATCH --job-name=il1b_tuned             # Name of job
...
mpiexec --bind-to core --npernode $cores --n $(($cores*$nodes)) python ~/st-mcmc-cme/examples/inflammation/il1beta_stmcmc_tuned.py
mpiexec --bind-to core --npernode $cores --n $(($cores*$nodes)) python ~/st-mcmc-cme/examples/inflammation/il1beta_predict_tuned.py

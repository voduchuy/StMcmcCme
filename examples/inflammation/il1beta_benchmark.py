...
if __name__ == "__main__":
    ...
    ax.plot(np.arange(0, model.num_surrogates), cput_multi_petsc, color='darkgreen', label='PETSC')
    ax.plot(np.arange(0, model.num_surrogates), cput_multi_cvode, color='r', label='CVODE')
